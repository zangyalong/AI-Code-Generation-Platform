...
import com.zangyalong.aicodegenerationplatform.common.DeleteRequest;
...
import com.zangyalong.aicodegenerationplatform.constant.UserConstant;
...
import com.zangyalong.aicodegenerationplatform.model.dto.app.*;
...
import com.zangyalong.aicodegenerationplatform.ratelimiter.annotation.RateLimit;
import com.zangyalong.aicodegenerationplatform.ratelimiter.enums.RateLimitType;
import com.zangyalong.aicodegenerationplatform.service.ProjectDownloadService;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.zangyalong.aicodegenerationplatform.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
    ...
    @RateLimit(limitType = RateLimitType.USER, rate = 5, rateInterval = 600, message = "AI 对话请求过于频繁，请稍后再试")
