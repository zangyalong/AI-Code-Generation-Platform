...
import com.zangyalong.aicodegenerationplatform.langgraph4j.ai.CodeQualityCheckService;
        ...
        return node_async(state -> {
            ...
            try {
                ...
                if(StrUtil.isBlank(codeContent)){
                    ...
                    CodeQualityCheckService codeQualityCheckService = SpringContextUtil.
